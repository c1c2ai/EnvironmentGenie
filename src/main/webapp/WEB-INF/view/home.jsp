                    ...
                    <div  class="mdl-card mdl-shadow--2dp demo-card-square">
                       ...
                       <div>
                        ...
                        <div class="mdl-card__supporting-text">
                            ...
                            <c:if test="${myServer.appstatus =='True'}">
                    ...
                    <c:if test="${myServer.appstatus =='True'}">
                            ...
                            <c:choose>
                                <c:when test="${myServer.appstatus=='True'}">
                                    ...
                                    <h7 title="App Status: Online"><img src="img/green_operational_icon.png" width="16px" height="16px"> App Status</h7><br/>
                                </c:when>
                                <c:otherwise>
                                    <h7 title="App Status: Offline"><img src="img/red_offline_icon.png" width="16px" height="16px"> App Status</h7><br/>
                                </c:otherwise>
